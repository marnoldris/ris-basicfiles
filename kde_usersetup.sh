...
install -v -C -o $USERNAME -g $GROUP -d /home/$USERNAME/Documents
install -v -C -o $USERNAME -g $GROUP -d /home/$USERNAME/Pictures
install -v -C -o $USERNAME -g $GROUP -d /home/$USERNAME/.config
